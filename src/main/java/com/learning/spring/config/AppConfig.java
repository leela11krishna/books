...
@ComponentScans(value = { @ComponentScan("com.learning.spring.dao"), @ComponentScan("com.learning.spring.service") })
public class AppConfig {
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		factoryBean.setPackagesToScan("com.learning.spring.model");
